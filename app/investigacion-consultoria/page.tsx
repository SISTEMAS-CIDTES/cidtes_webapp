  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <div className="group relative h-[600px] rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105">
              ...
              <div className="absolute bottom-12 left-12 right-12 z-10">
                <h3 className="text-3xl font-bold text-white mb-4">Beneficios a Estudiantes</h3>
                ...
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 max-h-0 group-hover:max-h-[400px] overflow-hidden">
                  <ul className="space-y-3 text-white text-sm">
                    ...
                    <li className="flex items-start">
                      <span className="mr-2">•</span>
                      <span>Desarrollo de estudiantes maduros, reflexivos y críticos</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2">•</span>
                      <span>Desarrollo la responsabilidad y el trabajo en equipo</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="mr-2">•</span>
                      <span>Aprovechamiento y aplicación de herramientas tecnológicas y procedimientos que posee la empresa</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="group relative h-[600px] rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105">
              ...
              {/* Title - Always visible */}
              <div className="absolute bottom-12 left-12 right-12 z-10">
                <h3 className="text-3xl font-bold text-white mb-4">Institución Educativa</h3>
        ...
        {/* Sistemas de Gestión Section */}
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="w-full text-center">
              <div
                className="text-white px-12 py-3 rounded text-center inline-block"
                style={{
                  background: 'linear-gradient(90deg, #0E9991 0%, #662686 100%)',
                  minWidth: '380px'
                }}
              >
              ...
              {/* Descripción */}
              <div className="mt-6">
                <p className="text-gray-800 mb-4 text-lg text-center">
                  Se analiza para <span className="font-bold">facilitar</span> la
                  implementación o <span className="font-bold">accesos</span> a los
                  sistemas de gestión a las PYMES:
                </p>
                {/* Lista centrada */}
                <ul className="space-y-1 text-gray-800 text-lg w-fit mx-auto">
