    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16">
        ...
        <section
          ...
          style={{
            backgroundImage:
              "url(/images/capacitacion/waves-background.jpg)",
              ...
              <div className="space-y-8 relative">
                ...
                <div>
                  ...
                  >
                    <path
                      d="M5 5H121"
                      stroke="url(#paint0_linear_cap_line)"
                      strokeWidth="9"
                      strokeLinecap="round"
                    />
                ...
                <div className="inline-block">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to right, #084E9F 0%, #01A0E1 47.9%, #662686 95.8%)",
                    }}
                  >
                ...
                <div className="space-y-6 text-gray-800 leading-relaxed text-lg">
                  ...
                  <p>
                    En nuestros cursos, hemos desarrollado una metodología
                    sólida alineada con la competitividad, fomentando un
                    entorno de aprendizaje relevante para el desarrollo
                    personal y profesional.
                  </p>

                  <p>
                    Valoramos la experiencia, autonomía y motivación del
                    aprendiz, utilizando la andragogía para facilitar la
                    conexión de nueva información con experiencias previas y
                    promover conocimientos duraderos y funcionales.
                  </p>

                  <p>
                    Hemos capacitado a más de 40,000 personas, potencializando
                    sus competencias laborales y las respaldamos a través de:
                  </p>
        ...
        <div className="w-full px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16 mb-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-2xl font-semibold text-[#1D63ED] mb-6">
                Contacto
              </h2>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-start mb-4">
                ...
                <p className="text-gray-800 text-center lg:text-left leading-relaxed">
                  Real de Los Reyes #303, Los Reyes, Alc. Coyoacán,
                  Ciudad de México, C.P. 04330, México.
                </p>
          ...
          <div className="border-t border-gray-300 pt-8">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-gray-700">
                ...
                <span>
                  © 2025 CIDTES Energía y Sustentabilidad.
                </span>
                ...
                <Link
                  href="#"
                  className="hover:text-[#1D63ED] transition-colors duration-300"
                >
                  Aviso de privacidad
                </Link>
