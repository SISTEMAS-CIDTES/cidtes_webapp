...
import CertificationProcessBottom from "@/components/certification-process-bottom"
...
export default function CertificacionPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Footer Section */}
      <footer id="contacto" className="relative z-20 bg-gray-100 shadow-[0_-5px_6px_rgba(0,0,0,0.05)] font-sans">
